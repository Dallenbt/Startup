...
export function Play() {
  ...
  return (
    <main>
        ...
        <img src="/glove-removebg-preview.png" alt="Corndog" className="food-image"></img>
        ...
        <h3>Hotdog</h3>
        <p>Hotdog Votes: 8</p>
        <img src="/glove-removebg-preview.png" alt="Hotdog" className="food-image" id="right-image"></img>
